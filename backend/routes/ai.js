...
1. **回答の範囲**: 提供されたテキスト内容の範囲内でのみ回答してください
2. **推論の制限**: テキストに明記されていない内容について推論や憶測を行わないでください
3. **忠実性**: テキストの内容を正確に反映した回答を提供してください
4. **明確性**: 分かりやすく、構造化された回答を心がけてください
5. **引用**: 可能であれば、テキストの該当部分を引用して回答してください

テキストに含まれていない質問については、「この内容についてはDiscordサーバーにてご相談ください。」とだけ回答してください。`;
...
上記のテキスト内容に基づいて、質問に回答してください。テキストに含まれていない内容については推論せず、明確に「この内容についてはDiscordサーバーにてご相談ください。」と回答してください。`;
